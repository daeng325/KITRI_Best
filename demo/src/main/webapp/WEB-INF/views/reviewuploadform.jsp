		...
		<div class="row justify-content-center">
			<div class="card">
				...
				<form action="complete" method="post" enctype="multipart/form-data">
					<table class="table">
						<tbody>
							<tr>
								<td>상품명</td>
								<td>${products.name}</td>
								<input type="hidden" name="products" value="${products.name}">
							</tr>
					...
					<div class="row justify-content-center" style="margin-bottom: 50px; margin-right:10px">
						<button type="submit" class="btn btn-primary" onclick="">완료</button>
					<div class="row justify-content-center" style="margin-bottom: 50px">
						<button type="submit" class="btn btn-primary" onclick="location.href='history.back()'">취소</button>
					</div>
				</form>
