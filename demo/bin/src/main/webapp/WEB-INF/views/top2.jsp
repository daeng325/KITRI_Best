...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img2-1" src="./jpg/2.jpg" alt="레이스블라우스">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">레이스블라우스</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">청순한 느낌의 어깨트임 레이스 블라우스.<br>
					봄, 가을에 착용하기 좋아요<br>
					지금 빨리 주문하세요^^
					<br>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg" alt="레이스블라우스"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg" alt="레이스블라우스"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg" alt="레이스블라우스"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg" alt="레이스블라우스"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg" alt="레이스블라우스"></div>
