...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img3-1" src="./jpg/5.jpg" alt="하드락티셔츠">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">하드락 티셔츠</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">락 공연에 입고가기 좋은 순면 반팔 하드락 티셔츠.<br>
					지금 빨리 주문하세요^^
					<br>
				</div>
				<div class="cotton1" align="center"><img src="./jpg/5.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/5.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/5.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/5.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/5.jpg"></div>
