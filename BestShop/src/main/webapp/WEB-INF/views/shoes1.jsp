...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img15-1" src="./jpg/26.jpg" alt="캔디핑크 슈즈">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">왕리본 캔디핑크 슈즈</div>
				<div class="card-body">
        ...
        <br>
     	<div class="mention">통통 튀는 화려한 도시적인 느낌을 가진 캔디핑크 구두<br>
					<br>
				<div class="cotton1" align="center"><img src="./jpg/26.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/26.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/26.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/26.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/26.jpg"></div><br>
