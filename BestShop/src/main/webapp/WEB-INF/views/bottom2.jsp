...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img7-1" src="./jpg/24.jpg" alt="테니스미니스커트">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">흰색 테니스 미니 스커트</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">왠지 입고 테니스 치러 나가야 될 것 같은 귀여운 치마<br>
					<br>
				<div class="cotton1" align="center"><img src="./jpg/24.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/24.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/24.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/24.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/24.jpg"></div><br>
