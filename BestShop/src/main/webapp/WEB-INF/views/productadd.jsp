...
<div class="cotainer" style="margin-bottom:50px">
	...
	<table class="table">
		<tbody>
			...
			<tr>
				<td>상품번호/아이디</td>
				<td><input type="text" id="product_id" name="product_id" class="form-control" placeholder="상품번호 입력" autofocus required></td>
			</tr>
			<tr>
				<td>종류</td>
				<td>
			...
			<tr>
				<td>설명</td>
				<td><textarea rows="10" cols="50" placeholder="상품 상세정보 입력" class="form-control" required></textarea>
				</td>
			</tr>
			<tr>
				<td>상품이미지</td>
