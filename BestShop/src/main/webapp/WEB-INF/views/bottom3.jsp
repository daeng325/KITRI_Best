	...
	<body>
		...
		<div class="col-md-7">
			...
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">플라워 쉬폰 스커트</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">살랑살랑 봄바람을 닮은 검은색 꽃무늬 스커트입니다.<br>
					세탁하기 좋은 소재로 이루어져 있어서 빨래하는데 1분도 안걸려요^^<br>
					주문 고고합시다~
					<br>
				<div class="cotton1" align="center"><img src="./jpg/25.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/25.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/25.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/25.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/25.jpg"></div><br>
