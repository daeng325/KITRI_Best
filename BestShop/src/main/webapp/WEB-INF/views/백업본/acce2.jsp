...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img15-1" src="./jpg/28.jpg" alt="블랙 페도라">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">멋쟁이 블랙 페도라</div>
				<div class="card-body">
        ...
        <br>
     	<div class="mention"><br>항상 잇템에서 빠지지 않았던 올타임 레전드, 페도라<br> 
					하나 장만해 놓는게 좋겠쥬?
					<br>
				<div class="cotton1" align="center"><img src="./jpg/44.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/45.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/46.jpg"></div><br>
			</div>
