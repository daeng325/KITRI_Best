...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img14-1" src="./jpg/27.jpg" alt="미러선글라스">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">레인보우 미러 선글라스</div>
				<div class="card-body">
        ...
        <br>
     	<div class="mention"><br>세상에서 가장 멋진 무지개색 빛이 나는 미러 선글라스<br>
					<br>
				<div class="cotton1" align="center"><img src="./jpg/27.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/27.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/27.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/27.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/27.jpg"></div><br>
