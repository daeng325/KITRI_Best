...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img6-1" src="./jpg/11.jpg" alt="블랙롱스커트">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">블랙 롱 스커트</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">베이직해서 어느 옷에나 다 잘어울리는 블랙 롱 스커트입니다.<br>
					진정한 사계절 잇템이죠^^<br>
					지금 빨리 주문하세요^^
					<br>
				<div class="cotton1" align="center"><img src="./jpg/11.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/11.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/11.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/11.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/11.jpg"></div>
