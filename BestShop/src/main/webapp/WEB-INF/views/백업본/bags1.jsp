	...
	<body>
		...
		<div class="col-md-7">
			...
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">미니 숄더백</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">큰 사이즈의 가방이 무겁고 불편한 분들에게.<br>
					언제든지 가볍게 들고 다니기 좋은 예쁜 숄더백 입니다.<br>
					은색과 노란색 두가지 옵션이 있으니 참고하세요^^
					<br>
				<div class="cotton1" align="center"><img src="./jpg/36.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/29.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/30.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/31.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/32.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/33.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/34.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/34.jpg"></div><br>
			</div>
