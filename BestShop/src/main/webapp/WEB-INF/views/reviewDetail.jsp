...
* a {
	...
	<div class="container-fluid">
		...
		id : ${reviews.id } <br> u_id : ${reviews.u_id } <br> price
		: ${reviews.rev_price} <br> quality : ${reviews.rev_quality} <br>
		ship : ${reviews.rev_ship} <br> agv : ${reviews.rev_agv} <br>
		내용 : ${reviews.content }<br> 이미지 : <img class="img1-1"
			src="${reviews.image_1 }" alt="${reviews.id}">
</body>
</html>