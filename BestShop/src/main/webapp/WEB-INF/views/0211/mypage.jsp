...
<h1 class="text-center" style="margin-bottom:50px">Purchase</h1>
<table class="table-bordered" style="height:350px;margin-left:auto;margin-right:auto">
<tbody>
<tr>
    <td><a href="selfuseredit"><img src="dollar.jpg" class="rounded" alt="무통장입금" style="width:100px; height:100px"></a>
    <a href="selfuseredit"><h4 class="card-title" style="text-align:center">무통장입금</h4></a>
    <td></td>
    <td><a href="orderedlist"><img src="bill.jpg" class="rounded" alt="실시간계좌이체" align="center" style="width:100px; height:100px"></a>
    <a href="orderedlist"><h4 class="card-title" style="text-align:center">실시간계좌이체</h4></a>
    <td></td>
    <td><a href="baskets"><img src="phone.jpg" class="rounded" alt="휴대폰 결제" style="width:100px; height:100px"></a>
    <a href="baskets"><h4 class="card-title" style="text-align:center">휴대폰 결제</h4></a>
    <td></td>
</tr>
</tbody>
</table>
