...
<tbody>
<tr>
    <td><a href="purchase1"><img src="dollar.jpg" class="rounded" alt="무통장입금" style="width:130px; height:130px"></a>
    <a href="purchase1"><h4 class="card-title" style="text-align:center">무통장입금</h4></a>
    <td></td>
    <td><a href="purchase2"><img src="bill.jpg" class="rounded" alt="실시간계좌이체" align="center" style="width:130px; height:130px"></a>
    <a href="purchase2"><h4 class="card-title" style="text-align:center">실시간계좌이체</h4></a>
    <td></td>
    <td><a href="purchase3"><img src="phone.jpg" class="rounded" alt="휴대폰결제" style="width:130px; height:130px"></a>
    <a href="purchase3"><h4 class="card-title" style="text-align:center">휴대폰결제</h4></a>
    <td></td>
</tr>
</tbody>
</table>
