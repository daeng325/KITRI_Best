...
<html>
	...
	<body>
		...
		<br>
		<br>
		<h2 style="text-align:center;text-decoration:bold">계정 정보 수정</h2>
		<br>
<div class="cotainer" style="margin-bottom:50px">
	...
	<table class="table">
		<tbody>
			<tr>
				<td>이름</td>
				<td><input type="text" id="username" name="username" class="form-control" value="${}" autofocus required></td>
			...
			<tr>
				<td>아이디</td>
				<td>
					<input type="text" id="user_id" name="user_id" class="form-control" placeholder="아이디 입력" value="${}" required>
				</td>
			</tr>
			<tr>
				<td>비밀번호</td>
				<td><input type="number" id="price" name="price" class="form-control" placeholder="비밀번호 입력" value="${}" required></td>
			</tr>
			<tr>
				<td>생성날짜</td>
				<td><script>
