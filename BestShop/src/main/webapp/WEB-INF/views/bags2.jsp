...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img10-1" src="./jpg/15.jpg" alt="소가죽백">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">고풍스러운 브라운 소가죽백</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">단돈 100000원이라는 놀라운 가격에<br>
					부드러운 고급 소가죽 여행가방을 선보입니다.<br>
					빨리 품절될 수 있으니 주문을 서둘러주세요^^
					<br>
				<div class="cotton1" align="center"><img src="./jpg/15.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/15.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/15.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/15.jpg"></div><br>
				<div class="cotton1" align="center"><img src="./jpg/15.jpg"></div><br>
