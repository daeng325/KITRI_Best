...
<html>
	...
	<body>
		...
		<div class="row">
		<div class="col-md-7">
				<img class="img4-1" src="./jpg/7.jpg" alt="어깨트임블라우스">
			</div>
			<div class="col-md-4" style="margin-top:40px">
				<div class="card">
				<div class="card-header">화이트 어깨트임 블라우스</div>
				<div class="card-body">
        ...
        <br>
        <div class="mention">귀여우면서도 섹시한 느낌의 어깨트임 크롭 블라우스<br>
					무더운 여름 바캉스날 더위 날려버리기~
					<br>
				</div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg"></div>
				<div class="cotton1" align="center"><img src="./jpg/7.jpg"></div>
