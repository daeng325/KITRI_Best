...
<h2 style="text-align:center;text-decoration:bold">Q&A 답변달기</h2>
        <br>
    ...
    <table class="table">
        <tbody>
            <tr>
                <td>작성자</td>
                <td>${name}</td>
                <!--DB에 있는 관리자 id가 표시되도록 ${}부분을 수정-->
            </tr>
            <tr>
                <td>제목</td>
                <td>${}</td>
                <!--질문종류가 Q&A게시판의 회원의 글과 같은 정보가 뜰 수 있도록 코드 작성-->
            </tr>
            <tr>
                <td>제목</td>
            ...
            <tr>
                <td>상품명</td>
                <td>${}</td>
                <!--회원의 글에 적힌 상품명 그대로 가져올 수 있도록 코드 작성-->
            </tr>
            <tr>
                <td>내용</td>
