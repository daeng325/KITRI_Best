		...
		<section>
			...
			<fieldset>
				<legend class="addinfo">부가정보</legend>
					...
					<input type="radio" name="agree" value="y">예
					<input type="radio" name="agree" value="n">아니오</p>
					<!--type=radio : 여러 값 중 하나를 선택할 수 있음-->
					<p><label for="agr2">이메일, 문자 수신에 동의합니까?</label>
					<input type="radio" name="agree2" value="y">예
					<input type="radio" name="agree2" value="n">아니오</p>
			</fieldset>
			<fieldset>
